...
prompt = prompt user for data entry; intended to be a string
   msg = error message printed for invalid input; intended to be string
    ok = 'anso' by default includes all character types; assign	permitted 		char types as desired [a=alpha, n=number, s=space, o=other]
